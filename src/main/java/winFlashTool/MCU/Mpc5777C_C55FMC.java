...
public class Mpc5777C_C55FMC extends Flash {
    ...
    private Mpc5777C_C55FMC()
    {
        ...
        super( /*isIdxPartitionZeroBased*/ true
             ...
             , new Range(0x00800000, 0x00840000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Boot */
             , new Range(0x00840000, 0x00880000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00880000, 0x008C0000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x008C0000, 0x00900000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00900000, 0x00940000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00940000, 0x00980000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00980000, 0x009C0000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x009C0000, 0x00A00000), Integer.valueOf(6), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00A00000, 0x00A40000), Integer.valueOf(7), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00A40000, 0x00A80000), Integer.valueOf(7), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00A80000, 0x00AC0000), Integer.valueOf(7), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00AC0000, 0x00B00000), Integer.valueOf(7), Boolean.valueOf(true)  /* Block type Large, Application code */
             , new Range(0x00B00000, 0x00B40000), Integer.valueOf(7), Boolean.valueOf(true)  /* Block type Large, Application code */
