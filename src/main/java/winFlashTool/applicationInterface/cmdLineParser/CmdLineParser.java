 ...
 *
 * Copyright (C) 2004, 2015-2025 Peter Vranken (mailto:Peter_Vranken@Yahoo.de)
 *
...
package winFlashTool.applicationInterface.cmdLineParser;
...
public class CmdLineParser implements Iterable<String>
{
     ...
     * Usually, this will be set to {@code false} and the usage string shows the list of
